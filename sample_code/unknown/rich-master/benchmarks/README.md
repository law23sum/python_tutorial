...
View the benchmark python_tutorial [here](https://textualize.github.io/rich-benchmarks/).
...
4. Run `asv preview` to launch a local webserver that will let you preview the benchmarks python_tutorial. Navigate to the URL
...
7. When the HTML is merged into `main`, the [benchmark python_tutorial](https://textualize.github.io/rich-benchmarks/) will be
