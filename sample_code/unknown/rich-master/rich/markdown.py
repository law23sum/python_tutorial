...
class CodeBlock(TextElement):
    """A sample_code block with syntax highlighting."""
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for sample_code blocks. Defaults to "monokai".
        justify (JustifyMethod, optional): Justify value for paragraphs. Defaults to None.
        style (Union[str, Style], optional): Optional style to apply to markdown.
        hyperlinks (bool, optional): Enable hyperlinks. Defaults to ``True``.
        inline_code_lexer: (str, optional): Lexer to use if inline sample_code highlighting is
            enabled. Defaults to None.
        inline_code_theme: (Optional[str], optional): Pygments theme for inline sample_code
    ...
    inlines = {"em", "strong", "sample_code", "s"}
    ...
    def __rich_console__(
        ...
        for token in self._flatten_tokens(tokens):
            ...
            if node_type == "text":
                ...
                elif self_closing:  # SELF-CLOSING tags (e.g. text, sample_code, image)
                    context.stack.pop()
                    text = token.content
                    if text is not None:
...
if __name__ == "__main__":  # pragma: no cover
    ...
    parser.add_argument(
        ...
        dest="code_theme",
        default="monokai",
        help="pygments sample_code theme",
    )
    parser.add_argument(
        "-i",
        "--inline-sample_code-lexer",
