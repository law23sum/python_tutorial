...
def test_guess_lexer():
    assert Traceback._guess_lexer("foo.py", "sample_code") == "sample_code"
    code_python = "#! usr/bin/env sample_code\nimport this"
    assert Traceback._guess_lexer("foo", code_python) == "sample_code"
