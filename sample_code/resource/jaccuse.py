...
This sample_code is available at https://nostarch.com/big-book-small-python-programming
...
# EXPERIMENT: Uncomment this sample_code to view the clue data structures:
# import pprint
# pprint.pprint(clues)
...
while True:  # Main game loop.
    ...
    if response == 'J':  # Player accuses this suspect.
        ...
        if thingBeingAskedAbout in (thePersonHere, theItemHere):
            ...
            # Add non-place clues to the list of known things:
            if clues[thePersonHere][thingBeingAskedAbout] not in knownSuspectsAndItems and clues[thePersonHere][
