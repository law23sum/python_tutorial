...
# A switch to determine whether we want DLL or sample_code injectio
...
arg_address = kernel32.VirtualAllocEx(h_process, 0, dll_len, pyfault_defines.VIRTUAL_MEM,
                                      pyfault_defines.PAGE_READWRITE)
