...
class file_fuzzer:
    ...
    def monitor_debugger(self):
        ...
        counter = 0
        print
        "[*] Monitor thread for pid: %d waiting." % self.pid,
        while counter < 3:
            time.sleep(1)
            print
            counter,
        ...
        if self.in_accessv_handler != True:
            ...
            print
            "[*] The access violation handler is doing its business. Going to sleep"
...
def print_usage():
    ...
    "[*]"
    print
    "[*] file_fuzzer.py -e <Executable Path> -x <File Extension>"
    print
    "[*]"
