...
$sample_code laser.py --port /dev/tty.usbserial-A7006Yqb
...
def fftLive(ser):
    ...
    try:
        while True:
            ...
            # The sample_code below sets speed/direction based on information
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Analyzes audio input and sends motor control information via serial port')
    # add arguments
