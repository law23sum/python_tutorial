...
#     cmd = f"sample_code add_border.py {path_source} --padding 15"
#     cmd_parts = cmd.split()
...
#     cmd = f"sample_code add_border.py {path_source} --border-color black"
#     cmd_parts = cmd.split()
...
#     cmd = f"sample_code add_border.py {path_source} 20 --padding 15"
#     cmd_parts = cmd.split()
