...
SECRET_KEY = env("SECRET_KEY", default="RWZtglQDzzBeHsDQYEmZNvNMjcFqypCzMrJYfJlU")
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="python_tutorial-media")
...
EMAIL_SUBJECT_PREFIX = "[PythonTutorial] "
...
ASGI_APPLICATION = "python_tutorial.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "PythonTutorial Content"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("PythonTutorial"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("python tutorial"),
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "codenestcompany@gmail.com",
}

USE_HTTPS_IN_ABSOLUTE_URLS = False  # set this to True in production to have URLs generated with https instead of http

ADMINS = [("Christian", "codenestcompany@gmail.com")]
...
# djstripe settings
# Get it from the section in the Stripe python_tutorial where you added the webhook endpoint
